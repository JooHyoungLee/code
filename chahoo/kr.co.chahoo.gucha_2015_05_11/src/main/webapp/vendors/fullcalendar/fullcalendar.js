		...
		_fetchEventSource(source, function(eventInputs) {
			...
			if (fetchID == currentFetchID) {
				...
				if (eventInputs) {
					...
					//alert('fetchEventSource For End');
				}
