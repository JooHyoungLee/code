...
public class RangeBar extends View {
    ...
    private static final float DEFAULT_TICK_HEIGHT_DP = 0;
    ...
    private static final int DEFAULT_THUMB_IMAGE_NORMAL = R.drawable.seek_point;
    private static final int DEFAULT_THUMB_IMAGE_PRESSED = R.drawable.seek_point;

    // Corresponds to android.R.color.holo_blue_light.
    private static final int DEFAULT_CONNECTING_LINE_COLOR = 0xff888888;
